"""
AIM:Write a program to implement water jug problem with two jugs the capacity of both the jugs should be
entered by user. The quantity of the water to be stored should also be dynamic. The output will show all the steps to get the final state
"""
